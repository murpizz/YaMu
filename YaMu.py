...
class YaMuMod(loader.Module):
    """
    Модуль для Яндекс.Музыки. Основан на YmNow от vsecoder. Создатель: @murpiz
    """
    strings = {
        "name": "YaMu",
        "no_token": "<b><emoji document_id=6030801830739448093>⚠️</emoji> Укажи токен в конфиге! Если вы видите это сообщение но уже указали токен то убедитесь в его правильности.</b>",
